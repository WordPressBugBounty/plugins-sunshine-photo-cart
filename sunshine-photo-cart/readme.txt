...
Free client photo gallery for professional photographers. Sell photos to your clients from your own WordPress website.

== Description ==

[Sunshine Photo Cart](https://www.sunshinephotocart.com/?utm_source=wordpress.org&utm_medium=link&utm_campaign=readme) is a free client photo gallery plugin for WordPress that let's you sell photos securely with professional features, no limits or commissions, and 100+ 5-star reviews. Quickly create galleries, sell photos to clients, and make more money than ever.

https://www.youtube.com/watch?v=wNGcKgWCigI
...
* Printable invoices
* International ready - Works with all currencies and translated into German, French, Spanish, Dutch, Finnish, Portuguese, British English, Norwegian, and more! [Learn more about translations](https://www.sunshinephotocart.com/docs/translations/)
...
* [Digital downloads](https://www.sunshinephotocart.com/addon/digital-downloads/?utm_source=wordpress.org&utm_medium=link&utm_campaign=readme) - Allow users to purchase digital download files at any size and have instant access to files securely
* [Discount codes](https://www.sunshinephotocart.com/addon/discounts/?utm_source=wordpress.org&utm_medium=link&utm_campaign=readme) - Boost sales with flexible discount codes, enticing customers to purchase more
* [Lightbox](https://www.sunshinephotocart.com/addon/lightbox/?utm_source=wordpress.org&utm_medium=link&utm_campaign=readme) - Deliver a seamless browsing experience with user-friendly lightboxes and slideshows for your clients
* [Advanced Analytics](https://www.sunshinephotocart.com/addon/analytics/?utm_source=wordpress.org&utm_medium=link&utm_campaign=readme) - Gain key insights from gallery analytics, best sellers, and precise profit figures to guide your sales approach
* [Price Levels (price sheets)](https://www.sunshinephotocart.com/addon/price-levels/?utm_source=wordpress.org&utm_medium=link&utm_campaign=readme) - Set unique prices for your products across your galleries giving you more control, flexibility, and profits
* [Packages](https://www.sunshinephotocart.com/addon/packages/?utm_source=wordpress.org&utm_medium=link&utm_campaign=readme) - Bundle products to offer clients more prints at a discounted price, encouraging larger purchases in a single transaction
* [Product Options](https://www.sunshinephotocart.com/addon/product-options/?utm_source=wordpress.org&utm_medium=link&utm_campaign=readme) - Increase sales by empowering customers with customizable options for anything from frames to paper types
* [Multi Image Products](https://www.sunshinephotocart.com/addon/multi-image-products/?utm_source=wordpress.org&utm_medium=link&utm_campaign=readme) - Products, like picture boxes or albums, that let customers select many photos
* [Sell Anything](https://www.sunshinephotocart.com/addon/sell-anything/?utm_source=wordpress.org&utm_medium=link&utm_campaign=readme) - Sell any type of product that does not require customers to select a photo from a gallery
* [Exports](https://www.sunshinephotocart.com/addon/exports/?utm_source=wordpress.org&utm_medium=link&utm_campaign=readme) - Simplify financial reporting and order fulfillment with effortless CSV exports of order data
* [Automated Emails](https://www.sunshinephotocart.com/addon/automated-email-marketing/?utm_source=wordpress.org&utm_medium=link&utm_campaign=readme) - Empower your outreach with automated emails, tailored to your clients’ gallery interactions for a personalized touch
* [Client messaging](https://www.sunshinephotocart.com/addon/messaging/?utm_source=wordpress.org&utm_medium=link&utm_campaign=readme) - Simplify the task of inviting clients to galleries with message templates
* [Minimum Order](https://www.sunshinephotocart.com/addon/minimum-order/?utm_source=wordpress.org&utm_medium=link&utm_campaign=readme) - Boost your sales by setting a minimum order requirement for checkout
* [Quantity Discounts](https://www.sunshinephotocart.com/addon/tiered-pricing/?utm_source=wordpress.org&utm_medium=link&utm_campaign=readme) - Stimulate larger purchases with quantity-based discounts for your clients
* [Price List](https://www.sunshinephotocart.com/addon/price-list/?utm_source=wordpress.org&utm_medium=link&utm_campaign=readme) - Effortlessly display product pricing on your page with our simple short code
* [Advanced Shipping](https://www.sunshinephotocart.com/addon/advanced-shipping/?utm_source=wordpress.org&utm_medium=link&utm_campaign=readme) - Set more complex rules for when specific shipping options are available
* [Exports](https://www.sunshinephotocart.com/addon/exports/?utm_source=wordpress.org&utm_medium=link&utm_campaign=readme) - Simplify financial reporting and order fulfillment with effortless CSV exports of order data
* [Light Blue](https://www.sunshinephotocart.com/addon/light-blue/?utm_source=wordpress.org&utm_medium=link&utm_campaign=readme) - Integrate with this popular photography CRM

Also available are these additional payment gateways with no added fees!

* [Stripe payment gateway](https://www.sunshinephotocart.com/addon/stripe/?utm_source=wordpress.org&utm_medium=link&utm_campaign=readme) (removes platform fees)
* [Square payment gateway](https://www.sunshinephotocart.com/addon/square/?utm_source=wordpress.org&utm_medium=link&utm_campaign=readme) (removes platform fees)
...
Sunshine comes with PayPal, Stripe, and Square out-of-the-box. Stripe and Square are subject to [5% platform fees with the free version](https://www.sunshinephotocart.com/docs/platform-fees/), upgrade to remove these platform fees. [See all available payment gateways](https://www.sunshinephotocart.com/payment-gateways/)

= Is there a demo? =

Yes! You can [fully demo Sunshine Photo Cart](http://demo.sunshinephotocart.com) or [create your own sandbox environment with full admin access](https://www.sunshinephotocart.com/sandbox/).
...
Yes! Please see our [translation site](https://www.sunshinephotocart.com/docs/translations/) for a list of all active translations, help refine an existing translation, or start a new one.
...
You can report security bugs through the Patchstack Vulnerability Disclosure Program. The Patchstack team help validate, triage and handle any security vulnerabilities. [Report a security vulnerability.](https://patchstack.com/database/vdp/sunshine-photo-cart)
...
7. Store View - showing products first and allow customers to add multiple images to cart at once
8. Sharing favorite images
